...
class RecipeController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request,[
           ...
           if($request->hasfile('images'))
           {
            ...
            $recipe->save();
            return redirect(route('member.recipe.index'))->with('success', 'Design added Successfully to pending list, Please wait for admin approval');
    }
    ...
    public function update(Request $request, Recipe $recipe)
    {
     ...
     $recipe->category_id = $request->categories;
     $recipe->save();
     return redirect(route('member.recipe.index'))->with('success', 'Design Updated Successfully');
    }
